...
function kopyala(x) {
  let copyOrijinalTatlar = x
  return copyOrijinalTatlar;
}
...
Aşağıdakileri yapmak için cesitEkle işlevini kullanın:
   1. İlk parametrede tatlar dizisini argüman olarak alan bir fonksiyon alın
...
function rastgeleTatlar(a, b, c, d) {
  ...
  for (let i = 0; i < 25; i++) {
    rastgeleTatlar.push(
      orijinalTatlar.concat(yeniTatlar, mevsimlikTatlar, bolgeselTatlar)[
